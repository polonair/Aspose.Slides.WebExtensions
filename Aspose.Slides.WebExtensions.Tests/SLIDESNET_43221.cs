...
{
    [TestClass]
    public class SLIDESNET_43221
    {
        [TestMethod]
        public void Test_43221()
        {
            var RootDirectory = Path.GetFullPath("../../../");
            var PresentationFilePath = Path.Combine(RootDirectory, "TestData", "SLIDESNET_43221", "SLIDESNET-43221.pptx");
            var EthalonPath = Path.Combine(RootDirectory, "TestData", "SLIDESNET_43221", "html");
            var TemplatePath = Path.Combine(RootDirectory, "TestData", "Out", "templates");
            var OutputPath = Path.Combine(RootDirectory, "TestData", "Out", "SLIDESNET_43221");
